...
public abstract class SOMaticManager_src {
	...
	public static int[] getSOMDimension(int numLoci, int numAttributes, int numTimes) {
		...
		somSizes[0] = SOMaticManager_src.findSOMDimension(numLoci);
		somSizes[1] = SOMaticManager_src.findSOMDimension(numAttributes);
		somSizes[2] = SOMaticManager_src.findSOMDimension(numTimes);
		somSizes[3] = SOMaticManager_src.findSOMDimension(numLoci * numAttributes);
		somSizes[4] = SOMaticManager_src.findSOMDimension(numLoci * numTimes);
		somSizes[5] = SOMaticManager_src.findSOMDimension(numAttributes * numTimes);
	...
	public static void runSOM_COD(String sominputFilePath, String somoutputFilePath, int neuronNumberX,
			...
			boolean rounding, int scalingFactor, int option, String perspective, String normalization,
	...
	public static void runSOM_COD(String trainingInputFilePath, File codInputFile, String somoutputFilePath,
			...
			int nThreads, boolean rounding, int scalingFactor, int option, String perspective, String normalization,
			FileWriter writer, int timeUnits, int stage) throws IOException {
